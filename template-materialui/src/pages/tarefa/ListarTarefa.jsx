...
const initialRows = [
  createData('01', 'Tarefa 01', 'Descrição', '2024-01-01', '2024-12-08', 'Concluída', 'Recurso 1'),
  createData('02', 'Tarefa 02', 'Descrição', '2024-01-03', '2024-12-08', 'Finalizada', 'Recurso 2'),
  createData('03', 'Tarefa 03', 'Descrição', '2024-01-04', '2024-12-08', 'Finalizada', 'Recurso 3'),
  createData('04', 'Tarefa 04', 'Descrição', '2024-01-05', '2024-12-08', 'Em Andamento', 'Recurso 4'),
  createData('05', 'Tarefa 05', 'Descrição', '2024-01-06', '2024-12-08', 'Em Andamento', 'Recurso 5'),
  createData('06', 'Tarefa 06', 'Descrição', '2024-01-07', '2024-12-08', 'Aguardando', 'Recurso 6'),
];
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 650, backgroundColor: 'lightblue'
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button variant="outlined" color="success" onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="small" /></Button>            
                      </TableCell>
                      <TableCell align="center">
        ...
        <CardActions>
            <Button color="secondary" size="small" variant="contained" onClick={handleOpen}>Nova Tarefa</Button>
            <Button color="secondary" size="small" variant="text">Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
